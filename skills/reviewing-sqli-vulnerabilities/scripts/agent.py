...
"""Review helper script for reviewing-sqli-vulnerabilities.
...
def main():
    parser = argparse.ArgumentParser(description="Automated check utility for reviewing-sqli-vulnerabilities")
