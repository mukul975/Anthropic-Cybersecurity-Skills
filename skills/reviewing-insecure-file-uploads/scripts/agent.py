...
"""Review helper script for reviewing-insecure-file-uploads.
...
def main():
    parser = argparse.ArgumentParser(description="Automated check utility for reviewing-insecure-file-uploads")
