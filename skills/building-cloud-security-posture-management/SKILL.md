...
description: >-
  Design and implement a cloud security posture management (CSPM) program for continuous monitoring across AWS, Azure, and GCP using tools like Wiz, Prisma Cloud, or native services.: cybersecurity
