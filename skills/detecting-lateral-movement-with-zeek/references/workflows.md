...
| Pass-the-Hash | ntlm.log | Same user from N+ distinct sources in time window |
...
| Pass-the-Hash detected | Force password reset for compromised accounts |
...
- Pass-the-Hash threshold exceeded → Auto-disable account + alert
