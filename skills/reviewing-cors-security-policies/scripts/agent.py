...
"""Review helper script for reviewing-cors-security-policies.
...
def main():
    parser = argparse.ArgumentParser(description="Automated check utility for reviewing-cors-security-policies")
