...
"""Review helper script for reviewing-xss-attack-vectors.
...
def main():
    parser = argparse.ArgumentParser(description="Automated check utility for reviewing-xss-attack-vectors")
