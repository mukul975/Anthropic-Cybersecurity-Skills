...
"""Review helper script for reviewing-jwt-implementation.
...
def main():
    parser = argparse.ArgumentParser(description="Automated check utility for reviewing-jwt-implementation")
