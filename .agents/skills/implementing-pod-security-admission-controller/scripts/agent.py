#!/usr/bin/env python3
"""Kubernetes Pod Security Admission audit."""
...
def main():
    p = argparse.ArgumentParser(description="Kubernetes Pod Security Admission audit")
    ...
    a = p.parse_args()
    print("[*] Kubernetes Pod Security Admission audit")
