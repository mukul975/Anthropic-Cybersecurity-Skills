...
description: >-
  Assess organizational cybersecurity maturity against NIST CSF 2.0 by scoring
  current capabilities across the Govern, Identify, Protect, Detect, Respond,
  and Recover functions and turning the results into a prioritized roadmap.
